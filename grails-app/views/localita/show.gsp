...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="localita.id.label"
                                                         default="Id"/></td>

                <td valign="top"
                    class="value">${fieldValue(bean: localitaInstance, field: "id")}</td>

            </tr>

            <tr class="prop">
                <td valign="top" class="name"><g:message code="localita.nome.label"
                                                         default="Nome"/></td>

                <td valign="top"
                    class="value">${fieldValue(bean: localitaInstance, field: "nome")}</td>
