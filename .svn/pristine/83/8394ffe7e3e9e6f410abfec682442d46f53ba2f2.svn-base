...
<div class="body">
    ...
    <g:hasErrors bean="${localitaInstance}">
        <div class="errors">
            <g:renderErrors bean="${localitaInstance}" as="list"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="nome"><g:message code="localita.nome.label"
                                                     default="Nome"/></label>
                    </td>
                    <td valign="top"
                        class="value ${hasErrors(bean: localitaInstance, field: 'nome', 'errors')}">
